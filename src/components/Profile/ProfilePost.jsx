import {
  Avatar, Button, Divider, Flex, GridItem, Image, Modal, ModalBody,
  ModalCloseButton, ModalContent, ModalOverlay, Text, VStack, useDisclosure
    ...
    try {
      ...
      try {
        ...
        if (error.code === 'storage/object-not-found') {
          showToast("Error", "File not found in storage", "error");
        } else {
          throw error;
        }
      }
      ...
      <Modal isOpen={isOpen} onClose={onClose} isCentered size={{ base: "3xl", md: "5xl" }}>
        ...
        <ModalContent>
          ...
          <ModalBody bg="black" pb={5}>
            <Flex gap={4} w={{ base: "90%", sm: "70%", md: "full" }} mx="auto" h="90vh">
              <Flex
                borderRadius={4}
                overflow="hidden"
                border="1px solid"
